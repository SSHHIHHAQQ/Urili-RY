...
export async function getAdminBuyerSessions(buyerId: number, params?: API.Partner.PartnerSessionPageParams) {
...
export async function getAdminBuyerAccountSessions(
  buyerId: number,
  buyerAccountId: number,
