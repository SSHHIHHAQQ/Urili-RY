...
export function isOptionAttributeType(attributeType) {
    return optionAttributeTypes.includes(attributeType || '');
}
export function isNumberAttributeType(attributeType) {
...
export function optionArrayToValueEnum(options) {
    return options.reduce((valueEnum, item) => {
