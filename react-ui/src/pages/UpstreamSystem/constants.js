...
export const credentialStatusText = {
    CONFIGURED: '已授权',
    INVALID: '授权异常',
};
export const skuSyncStateText = {
    NEVER: '未同步',
    SYNCING: '同步中',
    FRESH: '已同步',
    FAILED: '同步失败',
...
export const settlementTypeText = {
    'upstream-payable': '上游仓（应付）',
    'self-operated-receivable': '自营仓（应收）',
    UPSTREAM_PAYABLE: '上游仓（应付）',
    PLATFORM_ADVANCE: '自营仓（应收）',
};
export const normalizeSystemKindValue = (value) => value === 'LINGXING_WMS' ? 'lingxing-wms' : value || 'lingxing-wms';
export const normalizeSettlementTypeValue = (value) => {
