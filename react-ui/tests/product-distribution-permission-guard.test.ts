...
describe('product distribution permission guard', () => {
  ...
  it('keeps product review page and submit-review action permission guarded', () => {
    ...
    expect(reviewBusinessPreviewTsx).toContain("renderSection('新增 SKU'");
    expect(reviewBusinessPreviewTsx).toContain("renderSection('商品资料变化'");
    expect(reviewBusinessPreviewTsx).toContain("renderSection('SKU 资料变化'");
    expect(reviewBusinessPreviewTsx).toContain("renderSection('SKU 供货价对比'");
