...
call modify_direct_login_audit_columns_if_needed('seller_oper_log');
call modify_direct_login_audit_columns_if_needed('buyer_oper_log');
...
call assert_direct_login_audit_column_contract('seller_oper_log');
call assert_direct_login_audit_column_contract('buyer_oper_log');
