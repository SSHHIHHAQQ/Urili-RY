...
drop procedure if exists abort_deprecated_portal_audit_admin_menu_seed//
create procedure abort_deprecated_portal_audit_admin_menu_seed()
begin
...
call abort_deprecated_portal_audit_admin_menu_seed();
