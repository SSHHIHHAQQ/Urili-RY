...
drop procedure if exists abort_deprecated_admin_seller_account_permission_seed//
create procedure abort_deprecated_admin_seller_account_permission_seed()
begin
...
call abort_deprecated_admin_seller_account_permission_seed();
