...
values
    (2400, '商品列表', 2060, 5, 'list', 'Common/PlannedPage/index', '', 'ProductList',
     1, 0, 'C', '0', '0', 'product:list:list', 'AppstoreOutlined', 'admin',
     sysdate(), '', null, '商品管理菜单：商品列表，占位入口'),
    ...
    (2402, '分销商品', 2060, 15, 'distribution', 'Common/PlannedPage/index', '', 'DistributionProduct',
     1, 0, 'C', '0', '0', 'product:distribution:list', 'ShareAltOutlined', 'admin',
     sysdate(), '', null, '商品管理菜单：分销商品，占位入口'),
