...
/**
 * Buyer terminal product center browsing endpoints.
 */
@RestController
@RequestMapping("/buyer/product/center")
public class BuyerPortalProductCenterController extends BaseController
{
    @Autowired
    ...
    @GetMapping("/list")
    @Anonymous
    @PortalPreAuthorize(terminal = "buyer", hasPermi = "buyer:product:center:list")
    @PortalLog(terminal = "buyer", title = "买家端商品中心列表", businessType = BusinessType.OTHER,
    ...
    @GetMapping("/{spuId}")
    @Anonymous
    @PortalPreAuthorize(terminal = "buyer", hasPermi = "buyer:product:center:query")
    @PortalLog(terminal = "buyer", title = "买家端商品中心详情", businessType = BusinessType.OTHER,
        isSaveResponseData = false)
    ...
    @Anonymous
    @PortalPreAuthorize(terminal = "buyer", hasPermi = "buyer:product:center:query")
    @PortalLog(terminal = "buyer", title = "买家端商品中心 SKU", businessType = BusinessType.OTHER,
        isSaveResponseData = false)
